...
class smartcrop {
    ...
    public function canvasImageOperation($canvasFactory) {
    ...
    public function canvasImageAfterScale() {
    ...
    public function downSample($factor) {
        $width = floor ( imagesx ( $this->oImg ) / $factor );
        $height = floor ( imagesy ( $this->oImg ) / $factor );
